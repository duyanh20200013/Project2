...
import com.javaspringboot.Project2.exception.domain.UsernameExistException;
import com.javaspringboot.Project2.exception.token.TokenRefreshException;
import com.javaspringboot.Project2.enumm.ERole;
import com.javaspringboot.Project2.model.RefreshToken;
import com.javaspringboot.Project2.model.Role;
import com.javaspringboot.Project2.model.User;
import com.javaspringboot.Project2.payload.request.auth.LoginRequest;
import com.javaspringboot.Project2.payload.request.auth.SignupRequest;
...
import com.javaspringboot.Project2.security.jwt.JwtUtils;
import com.javaspringboot.Project2.security.services.RefreshTokenService;
...
public class AuthController extends ExceptionHandling {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) throws InvalidFormatException,UsernameExistException, EmailExistException,HttpMessageNotReadableException {
        ...
        User user = new User(signUpRequest.getUsername(),
                ...
                encoder.encode(signUpRequest.getPassword()), signUpRequest.getFullname(),signUpRequest.getPhone(),signUpRequest.getGioiTinh(),signUpRequest.getDiaChi());
